...
public class ProfileController {
    ...
    public ResponseEntity<BaseResponse<UserResponse>> getProfile(@AuthenticationPrincipal User user) {
        return ResponseEntity.ok(BaseResponse.success(profileService.getProfile(user.getEmail())));
    }
    ...
    public ResponseEntity<BaseResponse<UserResponse>> updateProfile(
        ...
        return ResponseEntity.ok(BaseResponse.success(profileService.updateProfile(user.getEmail(), request)));
    }
}
